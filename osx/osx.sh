...
sudo scutil --set ComputerName "warez"
sudo scutil --set HostName "warez"
sudo scutil --set LocalHostName "warez"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "warez"
